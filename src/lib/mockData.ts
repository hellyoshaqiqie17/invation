...
export const sampleGreenBatchPassports: GreenBatchPassport[] = [
  {
    ...
    supplier: "PT Sinar Baja Utama (Sertifikasi Hijau Tier-1)",
    productionLine: "Line 1",
    ...
    lifecycle: [
      ...
      { step: "FINAL PRODUCT", title: "Penerbitan Green Passport", description: "Batch dinyatakan VERIFIED dan siap dikirim dengan paspor digital", timestamp: "2026-09-04 14:30 WIB", parameter: "Status Paspor: TERVERIFIKASI HIJAU", verified: true, evidenceCode: "PASSPORT-SMN-00124" },
    ],
  },
  {
    ...
    lifecycle: [
      ...
      { step: "FINAL PRODUCT", title: "Penerbitan Green Passport", description: "Paspor hijau disetujui", timestamp: "2026-09-04 17:00 WIB", parameter: "STATUS: TERVERIFIKASI", verified: true, evidenceCode: "PASSPORT-SMN-00125" },
    ],
  },
  {
    ...
    lifecycle: [
      ...
      { step: "ESG", title: "Audit Tertunda", description: "Intensitas karbon melebihi target ambang batas hijau", timestamp: "2026-09-04 09:00 WIB", parameter: "34.2 kgCO₂e", verified: false, evidenceCode: "ESG-AUDIT-HOLD" },
      { step: "FINAL PRODUCT", title: "Audit Trail Flagged", description: "Paspor ditahan hingga teknisi menyelesaikan review M03", timestamp: "2026-09-04 11:15 WIB", parameter: "STATUS: PENDING AUDIT", verified: false, evidenceCode: "PASSPORT-SMN-HOLD" },
    ],
  },
];
...
export const initialSkillGapRoles: SkillGapRole[] = [
  ...
  },
  {
    ...
    targetCount: 18,
    progressPercent: 78,
    modules: ["Kalibrasi Kamera Inspeksi Vision AI", "Logging Digital Batch Hijau (Green Passport)", "Audit Bukti Ketertelusuran Material"],
  },
  {
    id: "SG-03",
...
export const initialAlerts: AlertItem[] = [
  ...
  },
  {
    ...
    message: "Jejak karbon 18.5 kgCO₂e tercatat rapi dengan 0 m³ ekstraksi air tanah. Sertifikat audit hijau A+ diterbitkan.",
    timestamp: "2 jam yang lalu",
    sourceId: "SMN-2026-00124",
    actionLabel: "Lihat Paspor Hijau",
